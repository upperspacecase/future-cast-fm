    ...
    <tr>
      <td align="center" style="padding: 40px 20px;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width: 480px; background-color: #000000; border: 1px solid rgba(250, 204, 21, 0.4); border-radius: 16px; overflow: hidden;">
          ...
          <tr>
            <td style="padding: 0 24px 16px 24px;">
              <p style="margin: 0 0 8px 0; color: rgba(255, 255, 255, 0.7); font-size: 14px; line-height: 1.6; font-style: italic;">
                A calendar invite is attached. Here&rsquo;s where we&rsquo;ll record:
              </p>
              <p style="margin: 0;">
                <a href="https://riverside.com/studio/tay-pattisons-studio-LUhKY?t=6473b6bbef5845aa4ed2" style="color: #2563eb; font-weight: bold; text-decoration: underline; font-size: 14px;">
                  Join the Riverside Studio
                </a>
              </p>
            </td>
          </tr>
...
${!isHost ? "A calendar invite is attached.\n\nJoin the Riverside Studio to record:\nhttps://riverside.com/studio/tay-pattisons-studio-LUhKY?t=6473b6bbef5845aa4ed2" : ""}
